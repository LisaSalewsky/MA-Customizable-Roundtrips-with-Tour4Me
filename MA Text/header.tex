...
\usepackage{svg}
\usepackage{pdfpages}
\setsvg{inkscape={"D:/Program Files/Inkscape/bin/inkscape.com"}}
\newcommand{\round}[2]{\pgfmathparse{round(#1*10^#2)/10^#2}\pgfmathprintnumber{\pgfmathresult}}
...
doi=true, backend=biber, defernumbers=false, uniquename=false, autolang=hyphen, minnames=99, maxnames=99, bibencoding=UTF-8]{biblatex}
