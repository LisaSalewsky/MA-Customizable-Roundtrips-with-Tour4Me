...
There is also considerable work on optimizing public transportation \cite{bastRoutePlanningTransportation2016, dellingRoundBasedPublicTransit2015} and managing traffic jams \cite{dellingTimeDependentSHARCRouting2011, dellingCustomizableRoutePlanning2017}. 
Examples are Dijkstra (uni- and bidirectional) \cite{madkourSurveyShortestPathAlgorithms2017, sommerShortestpathQueriesStatic2014, wayahdiGreedyAStarDijkstra2021}, A* search (also uni- and bidirectional) \cite{madkourSurveyShortestPathAlgorithms2017, sommerShortestpathQueriesStatic2014, wayahdiGreedyAStarDijkstra2021}, greedy algorithms \cite{madkourSurveyShortestPathAlgorithms2017, wayahdiGreedyAStarDijkstra2021}, branch-and-bound algorithms \cite{lawlerBranchandBoundMethodsSurvey1966}, the Bellman-Ford-Moore algorithm \cite{cherkasskyShortestPathsAlgorithms1996} and many more \cite{dellingEngineeringRoutePlanning2009, sommerShortestpathQueriesStatic2014}.
...
So, a different approach is needed for these kinds of routes \cite{gemsaEfficientComputationJogging2013}.
